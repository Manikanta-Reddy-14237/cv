...
class Player {
  ...
  strike (player, enemy, attackDmg) {
    ...
    //  Return a message of 'player name attacks enemy name for damageAmount'
       return(`${player}  attacks ${player} for ${damageAmount}`);
  }
  ...
  heal (player) {
    ...
    // Get random number between 1 - 5 and store that in hpAmount
     ...
     var hpAmount = Math.ceil(Math.random()*5);
...
const manikanta = new Player('Manikanta',100,10);
const james = new Player('James',100,10);
